...
| <a id="kustomization-annotations"></a>annotations |  Add annotations to add all resources.   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
...
| <a id="kustomization-image_names"></a>image_names |  Modify the names for certain images.   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
| <a id="kustomization-image_tags"></a>image_tags |  Modify the tags for certain images.   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
| <a id="kustomization-labels"></a>labels |  Add labels and optionally selectors to all resources.   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
...
| <a id="kustomization-patches"></a>patches |  Patches to be applied to resources. Expects a dictionary of patches to target specs. Keys must be a label to (a) patch file(s), values shall be a JSON string of a target spec.   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: Label -> String</a> | optional |  `{}`  |
...
controller_gen_crds(<a href="#controller_gen_crds-name">name</a>, <a href="#controller_gen_crds-srcs">srcs</a>, <a href="#controller_gen_crds-allow_dangerous_types">allow_dangerous_types</a>, <a href="#controller_gen_crds-generate_embedded_object_meta">generate_embedded_object_meta</a>, <a href="#controller_gen_crds-header_file">header_file</a>,
                    <a href="#controller_gen_crds-max_description_length">max_description_length</a>, <a href="#controller_gen_crds-year">year</a>, <a href="#controller_gen_crds-kwargs">**kwargs</a>)
</pre>
...
| <a id="controller_gen_crds-generate_embedded_object_meta"></a>generate_embedded_object_meta |  Generate embedded ObjectMeta for the CRD.   |  `False` |
