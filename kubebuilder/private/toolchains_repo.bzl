...
# By default all these toolchains are registered by the kubebuilder_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:kubebuilder_toolchain",
    toolchain_type = "@io_github_janhicken_rules_kubebuilder//kubebuilder:toolchain_type",
)
""".format(
            platform = platform,
